 ...
 */
function buildAgentPrompt(agent: AgentConfig, context: AgentExecutionContext): string {
 ...
 */
function simulateAgentResponse(agent: AgentConfig, context: AgentExecutionContext): string {
